    ...
    <div className={orderDetailsStyles.items}>
      ...
      <svg width="107" height="102" viewBox="0 0 107 102" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path fillRule="evenodd" clipRule="evenodd"
              ...
              fill="url(#paint0_radial_311_23)" fillOpacity="0.25"/>
        <path fillRule="evenodd" clipRule="evenodd"
              ...
              fill="url(#paint1_radial_311_23)" fillOpacity="0.25"/>
        <path fillRule="evenodd" clipRule="evenodd"
              ...
              fill="url(#paint2_radial_311_23)" fillOpacity="0.25"/>
        <path fillRule="evenodd" clipRule="evenodd"
              ...
              fill="#F2F2F3"/>
        <defs>
          <radialGradient id="paint0_radial_311_23" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse"
          ...
          <radialGradient id="paint1_radial_311_23" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse"
                          gradientTransform="translate(53.5 51) rotate(-43.0632) scale(73.2274 55.0025)">
            <stop stopColor="#801AB3" stopOpacity="0"/>
            <stop offset="1" stopColor="#4C4CFF"/>
          </radialGradient>
          <radialGradient id="paint2_radial_311_23" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse"
      ...
      <p className="pt-10 mt-10 pb-2 text text_type_main-default">Ваш заказ начали готовить</p>
