  ...
  return (
    <>
      ...
      <Routes location={background ?? location}>
        ...
        <Route path={resetPasswordUrl} element={<ProtectedRoute anonymous={true} children={<ResetPasswordPage/>}/>}/>
        <Route path={profileUrl} element={<ProtectedRoute anonymous={false} children={<ProfilePage/>}/>}>
          <Route path={`${ordersHistoryUrl}`} element={<ProtectedRoute anonymous={false} children={<ProfilePage/>}/>}/>
        </Route>
