...
const OrderCard = ({ingredient, number}) => {
  ...
  return (
    <div className={OrderContentsStyles.card}>
      <div className={OrderContentsStyles.div}>
      ...
      <div className={OrderContentsStyles.price}>
        <span className="text text_type_digits-default">{number} x {ingredient.price}</span>
  ...
  const OrderContents = () => {
    ...
    return (
      <div className={`${OrderContentsStyles.container} pb-20`}>
        ...
        <div className={(order.ingredients.length > 3 ? `${OrderContentsStyles.subcontainer} ${OrderContentsStyles.scrollbar} mb-10 pt-1 pl-1 pb-1` : `${OrderContentsStyles.subcontainer} mb-10 pt-1 pl-1 pb-1`)}>
